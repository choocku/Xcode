...
- (void)initMenu
{
    NSArray *imageList = @[[UIImage imageNamed:@"menuChat.png"], [UIImage imageNamed:@"layout.png"], [UIImage imageNamed:@"device.png"], [UIImage imageNamed:@"menuClose.png"], [UIImage imageNamed:@"menuClose.png"], [UIImage imageNamed:@"cuelist.png"]];
...
- (void)menuButtonClicked:(int)index
{
    ...
    if(index == 0){
        ...
        DeviceViewController *viewController = (DeviceViewController *)[storyboard instantiateViewControllerWithIdentifier:@"DeviceViewController"];
        [self presentViewController:viewController animated:YES completion:nil];
    }
    else if(index == 3){
        // allPreset
        AllPresetViewController *viewController = (AllPresetViewController *)[storyboard instantiateViewControllerWithIdentifier:@"AllPresetViewController"];
        [self presentViewController:viewController animated:YES completion:nil];
    }
    else if(index == 4){
        // effect offset
        ...
        CueListViewController *viewController = (CueListViewController *)[storyboard instantiateViewControllerWithIdentifier:@"CueListViewController"];
        [self presentViewController:viewController animated:YES completion:nil];
    }
