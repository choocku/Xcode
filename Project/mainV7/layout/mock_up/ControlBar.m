...
-(void)controlButton {
    ...
    [self createButton:containerView
                             ...
                             tag:1007
                               ...
                               w:width_controlButton
                               h:height_controlButton
                     buttonColor:[UIColor alizarinColor]
                     shadowColor:[UIColor pomegranateColor]
                    shadowHeight:3.0f
                      titleColor:[UIColor cloudsColor]
    ...
    [self createButton:containerView
                             ...
                             tag:1008
                               ...
                               w:width_controlButton
                               h:height_controlButton
                     buttonColor:[UIColor colorWithRed:0.2 green:0.431 blue:0.482 alpha:1]  //MING
                     shadowColor:[UIColor midnightBlueColor]
                    shadowHeight:3.0f
                      titleColor:[UIColor cloudsColor]
...
-(void)dimValue:(TBCircularSlider*)slider{
    ...
    [controlBarClass toString:[theArrayTest mutableCopy] thatView:@"controlbar" action:@"control/"];
...
- (void)changeSwitch:(id)sender{
    if([sender isOn]){
        ...
        for (int i=0; i<[controlBarClass.selected count]; i++) {
            ...
            int patchIndex = [[[controlBarClass.device objectAtIndex:deviceIndex] objectAtIndex:0] intValue]-1;
            if( deviceIndex==patchIndex ) {
                ...
                [test setObject:[NSString stringWithFormat:@"%d",255] forKey:[NSString stringWithFormat:@"%@",[controlBarClass.nameCH objectAtIndex:10]]];
                [test setObject:[NSString stringWithFormat:@"%d",255] forKey:[NSString stringWithFormat:@"%@",[controlBarClass.nameCH objectAtIndex:11]]];
                
                [self setData:deviceIndex ch:5 obj:[NSString stringWithFormat:@"%d",255]];
                [self setData:deviceIndex ch:10 obj:[NSString stringWithFormat:@"%d",255]];
                [self setData:deviceIndex ch:11 obj:[NSString stringWithFormat:@"%d",255]];
        ...
        for (int i=0; i<[controlBarClass.selected count]; i++) {
            ...
            if( deviceIndex==patchIndex ) {
                ...
                [test setObject:[NSString stringWithFormat:@"%d",0] forKey:[NSString stringWithFormat:@"%@",[controlBarClass.nameCH objectAtIndex:10]]];
                [test setObject:[NSString stringWithFormat:@"%d",0] forKey:[NSString stringWithFormat:@"%@",[controlBarClass.nameCH objectAtIndex:11]]];
                
                [self setData:deviceIndex ch:5 obj:[NSString stringWithFormat:@"%d",0]];
                [self setData:deviceIndex ch:10 obj:[NSString stringWithFormat:@"%d",0]];
                [self setData:deviceIndex ch:11 obj:[NSString stringWithFormat:@"%d",0]];
...
-(void)store {
    ...
    if (controlBarClass.storeState) {
        ...
        storeButton.buttonColor = [UIColor alizarinColor];
        storeButton.shadowColor = [UIColor pomegranateColor];
        //((FUIButton *)sender).buttonColor = [UIColor alizarinColor];
        //((FUIButton *)sender).shadowColor = [UIColor pomegranateColor];
        NSLog(@"state=false");
    }
    else {
        controlBarClass.storeState = true;
        storeButton.buttonColor = [UIColor emerlandColor];
        storeButton.shadowColor = [UIColor nephritisColor];
//        ((FUIButton *)sender).buttonColor = [UIColor emerlandColor];
//        ((FUIButton *)sender).shadowColor = [UIColor nephritisColor];
        NSLog(@"state=true");
    }
}
