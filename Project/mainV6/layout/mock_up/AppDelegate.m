...
//    [lagFreeField removeFromSuperview];
    ...
    [self sendUDP:@"request/patching"];
    [self sendUDP:@"request/groupdevice"];
    [self sendUDP:@"request/controlbar"];
    [self sendUDP:@"request/allpreset"];
    [self sendUDP:@"request/cuelist"];
    return YES;
}
