...
//        [self toString:[theArrayTest mutableCopy]];     /* send JSON form */
        [deviceClass toString:[theArrayTest mutableCopy] thatView:@"groupdevice" action:@"&"];
...
//    theBigDictionary = [NSMutableDictionary dictionaryWithObject:theArray forKey:@"groupdevice"];
//    
