...
/** Parameters **/
#define TB_SLIDER_SIZE 240                          //The width and the heigth of the slider
#define TB_BACKGROUND_WIDTH 40                      //The width of the dark background
#define TB_LINE_WIDTH 30                            //The width of the active area (the gradient) and the width of the handle
#define TB_FONTSIZE 25                              //The size of the textfield font
